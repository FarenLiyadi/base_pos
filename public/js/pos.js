        ...
        $('#search_product')
            .autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    if (
                        $('#status') &&
                        ($('#status').val() == 'quotation' || $('#status').val() == 'draft')
                    ) {
                        var is_draft = true;
                    }
...
function saveFormDataToLocalStorage() {
    ...
    let shipping_charges_amount = formArray.findIndex(
        (item) => item.name === 'shipping_charges_amount'
    );
    ...
    if (priceIndex !== -1) {
        ...
        formArray.push({
            ...
            value: $('#shipping_charges_amount').text().trim(),
        });
    }
